...
export const DATA = {
  name: 'Leon',
  initials: 'LG',
  url: 'https://portfolio-leon-gao.vercel.app/',
  location: 'Stockholm',
  ...
  contact: {
    email: 'leon.gao.personal@outlook.com',
    tel: '+123456789',
    social: {
      GitHub: {
        name: 'GitHub',
        url: 'https://github.com/fortune-cook1e',
        icon: Icons.github,
      ...
      LinkedIn: {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/leongaol',
        icon: Icons.linkedin,
  ...
  work: [
    ...
    },
    {
      company: 'Mobikok',
      badges: [],
      href: 'https://www.mobikok.com/',
      location: 'Shenzhen, China',
      title: 'Software Engineer',
      logoUrl: '/mobikok.jpeg',
      start: 'Jul 2019',
      end: 'Jul 2020',
      description:
